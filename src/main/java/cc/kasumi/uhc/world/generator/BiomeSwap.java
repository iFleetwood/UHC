...
public class BiomeSwap
{
    ...
    public void startWorldGen() {
        try {
            Class<?> biomeHandler = Class.forName("cc.kasumi.uhc.world.generator.BiomeHandler");
            swapper = ((BiomeHandler) biomeHandler.getConstructor(new Class[0]).newInstance(new Object[0]));
